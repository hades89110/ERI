<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EfficiencyAppNew110.aspx.cs" Inherits="Efficiency_EfficiencyAppNew110" MasterPageFile="~/_master/MasterPageEPA2.master" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div runat="server" id="divMain">
        ...
        <asp:DropDownList runat="server" ID="ddlCounty" AutoPostBack="true" OnSelectedIndexChanged="ddlCounty_SelectedIndexChanged"></asp:DropDownList>
        <asp:Button runat="server" ID="View109Detail" OnClick="View109Detail_Click" Text="查閱110年度資料" /><p></p>
                    ...
                    <ol>
                        ...
                        <li>辦理毒災通聯測試及通聯資料異動上網更新，最高 2 分。列管總家數通聯測試達 5 %（含第 4 類毒化物），最高得 1 分。
                            <div class="divInput">
                                ...
                                場次。
                                <span class="CR">（請直接點擊連結進行場次的輸入）</span>
                                <br />
                                <asp:Repeater ID="rpDefence" runat="server" OnItemDataBound="rpDefence_ItemDataBound">
                                    <ItemTemplate>
                                        組織<asp:Label runat="server" ID="lbGroup1" Text="" Height="23px"></asp:Label>
                                        <asp:TextBox runat="server" CssClass="txtBasic" ID="txtGroupNums"></asp:TextBox> 家
                                        <span class="CR">（共<asp:Label runat="server" ID="lbGroupNoNum" Text=""></asp:Label> 家）</span>
                                        <br />
                                    </ItemTemplate>
                                </asp:Repeater>
                                <span class="CG">◎執行效益及特色（請摘要敘述）</span><br />
                        ...
                        <li>督導業者更新（或確認）聯防組織線上系統資料達80%以上者，得1分。辦理轄內聯防組織無預警測試，達90％以上，最高得1分。
                            ...
                            <div class="divInput">
                                ...
                                <asp:Label ID="lbPSum" runat="server" Text="Label" Visible="false" CssClass="CR" />
                                <asp:Repeater ID="rpDefenceNW" runat="server" OnItemDataBound="rpDefenceNW_ItemDataBound">
                                    <ItemTemplate>
                                        組織<asp:Label runat="server" ID="lbGroup2" Text="" Height="23px"></asp:Label>
                                        <asp:TextBox runat="server" CssClass="txtBasic" ID="txtGroupNums"></asp:TextBox> 家
                                        <span class="CR">（共<asp:Label runat="server" ID="lbGroupNoNum" Text=""></asp:Label> 家）</span>
                                        <br />
                                    </ItemTemplate>
                        ...
                        <li>運送車輛勾稽異常抽驗（起運地或迄運地毒性化學物質之車輛查核為主）作業，查核1次0.5分，最高得2分。
                            <br />
                            <%--<span style="color: red;">（資料更新日期：N/A）</span>--%>
                            <div class="divInput">
                                查核次數：
